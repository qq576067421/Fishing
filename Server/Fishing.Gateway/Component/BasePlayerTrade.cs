...
public class BasePlayerTrade<TDef> : Component<TDef> where TDef : DefPlayerTrade, new()
{
    //-------------------------------------------------------------------------
    ...
    public override void init()
    {
        ...
        defNodeRpcMethod<PlayerTradeRequest>(
        (ushort)MethodType.c2sPlayerTradeRequest, c2sPlayerTradeRequest);
    }
